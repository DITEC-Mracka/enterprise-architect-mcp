 ...
 */
export function resolveQeaPath(cliArg) {
    const target = cliArg || process.env.EA_QEA_PATH || loadFromDotEnv();
    if (!target) {
        throw new Error("No .qea path provided. Pass as CLI argument, set EA_QEA_PATH env var, or add EA_QEA_PATH to .env in the working directory.");
    }
