...
export function configureSearchTools(server, db) {
    server.tool("ea_search", "Search Enterprise Architect model elements by name, alias, notes, attribute names/notes, operation names/notes, or constraint notes. Matches across the full Slovak alphabet including encoded entities. Returns matching elements with a decoded note preview and truncation flag.", {
