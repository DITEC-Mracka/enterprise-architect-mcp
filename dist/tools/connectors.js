...
export function configureConnectorTools(server, db) {
    server.tool("ea_get_connectors", "Get all relationships (connectors) for a given element. Shows what the element is connected to and how (Realisation, Dependency, Association, etc.). Feature links show which specific attribute or operation each connector end attaches to.", {
