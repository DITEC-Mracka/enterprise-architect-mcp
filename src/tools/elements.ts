...
export function configureElementTools(server: McpServer, db: Database): void {
  server.tool(
    "ea_get_element",
    "Get full details of an Enterprise Architect element by its ID, including its note/description, attributes, and operations.",
    {
  ...
  server.tool(
    "ea_list_elements",
    "List elements within a package, optionally filtered by object type. Returns a lightweight list (ID, type, name, alias, stereotype).",
    {
