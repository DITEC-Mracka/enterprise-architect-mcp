...
export function configurePackageTools(server: McpServer, db: Database): void {
  server.tool(
    "ea_get_package_tree",
    "Navigate the package hierarchy. Without parameters, returns top-level packages. With a packageId, returns that package's children up to the specified depth.",
    {
