...
export function configureDiagramTools(server: McpServer, db: Database): void {
  server.tool(
    ...
    "Get all elements placed on a specific diagram, along with the diagram's metadata. Useful for understanding what a diagram shows without needing the visual.",
    {
