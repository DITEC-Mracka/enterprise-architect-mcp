...
export function configureResolveTools(server: McpServer, db: Database): void {
  server.tool(
    "ea_resolve",
    "Resolve an analyst reference (braced GUID or plain name) to model candidates. Each candidate reports what it is (element, diagram, package), its ID, name, and full package path. Use the optional kind filter to narrow results.",
    {
